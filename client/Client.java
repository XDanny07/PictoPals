...
public class Client extends JFrame {
         ...
         imgselect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (jFileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                    ...
                    JFrame imageFrame = new JFrame("Selected Image");
                    ...
                    try {
                        ...
                        if (fileNameLength > 0) {
                            ...
                            if (fileContentLength > 0) {
                                ...
                                downloadButton.setBorder(BorderFactory.createEmptyBorder(10, 20, 10, 20)); // Add padding
                                ...
                                if (fileContentBytes != null) {
                                    ...
                                    Image receivedImage = receivedImageIcon.getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
    ...
    private void sendMessage() {
        ...
        if (!contentToSend.equals("")) {
            appendToPane(messagePane, "User1: " + contentToSend + "\n", Color.BLACK, true);
